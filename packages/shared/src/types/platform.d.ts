...
export type AuditAction = "patient.created" | "patient.called" | "patient.completed" | "settings.updated" | "doctor.updated" | "queue.paused" | "queue.resumed" | "QUEUE_RESET" | "appointment.created" | "notification.queued";
